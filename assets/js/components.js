...
const EMODUS_TYPES = [
  ...
  },
  {
    images: [
      ...
      '/assets/img/types/2-snap/0663.png',
      '/assets/img/types/2-snap/0711.png',
      '/assets/img/types/2-snap/1208.png',
      '/assets/img/types/2-snap/1573.png',
      '/assets/img/types/2-snap/2091.png',
      '/assets/img/types/2-snap/2931.png',
      '/assets/img/types/2-snap/3028.png',
      '/assets/img/types/2-snap/3029.png',
      '/assets/img/types/2-snap/3112.png',
    ],
    title: 'Modus Snap',
    subtitle: '90 pieces',
    description:
